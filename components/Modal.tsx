  ...
  return (
    ...
    >
      <>
        <button
          onClick={handleClose}
          className="modalButon absolute rigth-5 top-5 !z-40 h-9 w-9 border-none bg-[#181818]
          hover:bg-[#181818] "
        >
        ...
        <div className="relative pt-[56.25%]">
          <ReactPlayer
            ...
            muted={muted}
          />
          <div className="absoulte bottom-10 flex w-full items-center justify-between px-10">
